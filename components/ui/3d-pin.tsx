    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  shadow-[0_8px_16px_rgba(0,0,0,0.4)] bg-card border border-border group-hover/pin:border-border/80 transition duration-700 overflow-hidden"
        >
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none w-60 h-48 sm:w-64 sm:h-52 md:w-72 md:h-56 lg:w-80 lg:h-64 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
        ...
        >
          <>
            <motion.div
              ...
              className="absolute left-1/2 top-1/2  h-[11.25rem] w-[11.25rem] rounded-[50%] bg-primary/[0.08] shadow-[0_8px_16px_rgba(0,0,0,0.4)]"
            ></motion.div>
            <motion.div
              initial={{
                opacity: 0,
