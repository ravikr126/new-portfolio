  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-10">
        <h2 className="text-3xl md:text-4xl mb-4 text-foreground max-w-4xl">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full border border-border flex items-center justify-center bg-background">
                <div className="h-4 w-4 rounded-full bg-primary border-2 border-background shadow-lg animate-pulse" />
              </div>
