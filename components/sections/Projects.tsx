...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      ref={sectionRef}
      className="pt-20 pb-5 md:pb-10 px-4"
    >
      <div className="container mx-auto max-w-6xl">
        <div className="text-center space-y-2 md:space-y-3 mb-20 md:mb-12 lg:mb-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-36 gap-x-8 sm:gap-y-32 sm:gap-x-6 md:gap-y-34 md:gap-x-8 lg:gap-16">
          {cards.map((c, index) => (
            <PinContainer key={c.title} title={c.linkTitle} href={c.link}>
              <div
                data-proj
