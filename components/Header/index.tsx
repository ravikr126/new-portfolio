...
const moreItems = [
  ...
  { name: "Book a Call", link: "/book-call" },
];
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/30 backdrop-blur-sm">
        <div className="container mx-auto item-center px-4 py-2 flex items-center justify-between">
...
function Navbar({ className }: { className?: string }) {
  ...
  const allNav = [
    ...
    { name: "Book a Call", link: "/book-call", icon: null }
  ];
